        ...
        <div className="mt-14 grid gap-6 md:grid-cols-2">
          {SERVICE_GROUPS.map((group, i) => {
            ...
            return (
              <motion.article
                key={group.id}
                className="group relative flex flex-col overflow-hidden rounded-3xl border border-line bg-white transition-colors duration-300 hover:border-brand-900/15 hover:shadow-xl hover:shadow-brand-950/8"
                {...revealDelay(i)}

  ...
  return (
    <section id="services" className="scroll-mt-20 bg-paper py-24 sm:py-28">
      <div className="container-x">
        ...
        <div className="mt-14 grid gap-6 md:grid-cols-2">
          {SERVICE_GROUPS.map((group, i) => {
            ...
            return (
              <article
                key={group.id}
                className="group relative flex flex-col overflow-hidden rounded-3xl border border-line bg-white transition-all duration-300 hover:-translate-y-1 hover:border-brand-900/15 hover:shadow-xl hover:shadow-brand-950/8"
                data-reveal
              >
                {/* Image header */}
        ...
        <div
          className="mt-12 flex flex-col items-start gap-4 rounded-3xl bg-brand-950 px-8 py-8 text-paper sm:flex-row sm:items-center sm:justify-between sm:px-10"
          data-reveal
        >
